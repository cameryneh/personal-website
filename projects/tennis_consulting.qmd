...
###### &rarr; sign in to the [site](https://match-manager-xi.vercel.app) with the demo username and password &rarr; add '/match-list'  to the end of the url &rarr; select any 'Tag Match - Full' buttons {style="text-align: center;"}
